...
import com.example.backgroundtask.adapter.CityAdapter.CityViewHolder
...
class CityAdapter(var cityList: ArrayList<CityDetails>, var ctx: Context) :
    RecyclerView.Adapter<CityViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CityViewHolder {
        val recyclerInflater = LayoutInflater.from(ctx)
        @SuppressLint("InflateParams") val recyclerView =
            recyclerInflater.inflate(R.layout.city_list_layout, null)
    ...
    override fun onBindViewHolder(holder: CityViewHolder, position: Int) {
        ...
        holder.latitude.text = String.format("%.2f", cityTemp.latitude)
        holder.longitude.text = String.format("%.2f", cityTemp.longitude)
    }
    ...
    inner class CityViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(v: View) {
            ...
            val i = Intent(ctx, WeatherDetails::class.java)
